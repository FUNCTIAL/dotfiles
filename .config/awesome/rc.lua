...
theme              = "fx"
Global.ThemeFolder = Global.ConfigFolder .. "deco/themes/" .. theme .. "/"
beautiful.init(Global.ThemeFolder .. "theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "code", "browse", "notes", "etc" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    -- System
    awful.key({}, "XF86MonBrightnessUp", function() os.execute("brightnessctl -cbacklight s 10%+") end,
        { description = "brightness up", group = "system" }),
    awful.key({}, "XF86MonBrightnessDown", function() os.execute("brightnessctl -cbacklight s 10%-") end,
